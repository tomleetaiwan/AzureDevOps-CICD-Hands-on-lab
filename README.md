...
* 下載安裝 [Git for Windows](https://gitforwindows.org/) ，Visual Studio Code 必須搭配 Git 2.0 以上版本
...
* [前往練習 Lab 3](Labs-03.md) : 建立 Azure Web App for Containers - Linux 與 Azure Container Registry
